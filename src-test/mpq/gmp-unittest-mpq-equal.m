...
#include "gmp-impl.h"
#include "tests.h"
#import "gmp-unittest-mpq-equal.h"


@implementation gmp_unittest_mpq_equal
/**
 *
 */
-(void) setUp
 ...
 *
 */
-(void) check_one:(mpq_srcptr) x :(mpq_srcptr) y :(int) want
{
  int  got;
 ...
 *
 */
-(void) check_all:(mpq_ptr) x :(mpq_ptr) y :(int) want
{
  [self check_one:x :y :want];
  [self check_one:y :x :want];
