...
#import "gmp-unittest-mpq-aors.h"


@implementation gmp_unittest_mpq_aors
 ...
 *
 */
-(void) check_all:(mpq_ptr) x :(mpq_ptr) y :(mpq_ptr) want_add :(mpq_ptr) want_sub
{
  mpq_t  got;
...
-(void) check_data
{
  ...
  for (i = 0; i < numberof (data); i++)
  {
    ...
    [self check_all:x :y :want_add :want_sub];
  }
