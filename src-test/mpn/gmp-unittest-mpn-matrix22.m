...
@interface gmp_unittest_mpn_matrix22 : SenTestCase 
{ }
@end
...
@implementation gmp_unittest_mpn_matrix22
...
-(void) one_test:(const struct matrix *)A :(const struct matrix *) B :(int) i
{
  struct matrix R;
  struct matrix P;
  mp_ptr tp;
